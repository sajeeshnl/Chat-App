var wsUri = getServerRootUri() + "/Schat111/chat-server";
var currentUsername = "";
var chatWebsocket;
...
function signin() {
    ...
    if (retVal != "" && retVal != null) {
        ...
        chatWebsocket = new WebSocket(wsUri, "Schat111");
...
function button_sendMessage() {
    ...
    if (chatString.length > 0) {
        chatWebsocket.send("ctmsg"  + currentUsername  + "~" + chatString + "~" +   recipient );
